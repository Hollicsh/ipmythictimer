...
Addon.localization.KEYSNAME   = "Nombre de las Miticas"
...
Addon.localization.RNMKEYSBT  = "Renombrar Miticas"
Addon.localization.RNMKEYSTT  = "Aquí puedes cambiar el nombre de las Miticas en el temporizador"
